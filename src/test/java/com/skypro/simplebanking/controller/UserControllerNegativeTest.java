...
class UserControllerNegativeTest {
    ...
    @SneakyThrows
    @Description("createUserBadRequest")
    @Test
    @Transactional
    void createUserBadRequestTest(@Value("${app.security.admin-token}") String adminToken) {
        User randomUser = controllerTestData.getRandomUser();
        JSONObject userJson = new JSONObject();
        userJson.put("username", randomUser.getUsername());
        userJson.put("password", randomUser.getPassword());
        ;
    ...
    @SneakyThrows
    @DisplayName("getAllUsersUnauthorized")
    @Test
    ...
    @SneakyThrows
    @DisplayName("getMyProfileForbidden")
    @Test
    void getMyProfileForbiddenTest(@Value("${app.security.admin-token}") String adminToken) {
    ...
    @SneakyThrows
    @DisplayName("createUserForbidden")
    @Test
    void createUserForbiddenTest() {
        User randomUser = controllerTestData.getRandomUser();
